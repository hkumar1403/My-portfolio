...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center px-8 md:px-16 pt-24 bg-black text-white overflow-hidden">
      
      {/* ===== LEFT CONTENT ===== */}
      <div className="relative z-10 max-w-6xl">
        <h1 className="text-[3.5rem] md:text-[6rem] font-light leading-none italic">
          Full-stack
        </h1>

        <h2 className="text-[3.5rem] md:text-[6rem] font-bold leading-none">
          <span ref={typedRef} />
        </h2>
        ...
        <p className="mt-8 max-w-xl text-gray-400 text-base md:text-lg">
          ...
          so that building software stays enjoyable.
        </p>
